...
const Hero = () => {
  ...
  const renderStatistics = () => statistics.map((stat, index) => (
    <div key={index}>
  ...
  const renderShoes = () => shoes.map((shoe) => (
    <div key={shoe}>
      <Shoecard
        imgURL={shoe}
  ...
  return (
    <section id="home" className='w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container'>
      ...
      <div className="relative flex-1 flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-cover bg-center">
        <img src={bigShoeImage} alt="showcollection" width={610} height={502} className="object-contain relative z-10" />
